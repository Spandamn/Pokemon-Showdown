...
export const Moves: {[k: string]: ModdedMoveData} = {
	...
	*/
	...
	pandaexpress: {
		...
		basePower: 0,
		category: "Status",
		desc: "Lowers the target'sSpecial Attack by 2 stage. If this move is successful, the user switches out even if it is trapped and is replaced immediately by a selected party member. The user does not switch out if the target's Attack and Special Attack stat stages were both unchanged, or if there are no unfainted party members.",
