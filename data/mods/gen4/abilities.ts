export const BattleAbilities: {[k: string]: ModdedAbilityData} = {
	...
	intimidate: {
		inherit: true,
		onStart(pokemon) {
			let activated = pokemon.adjacentFoes().some(foe => !(
				foe.volatiles['substitute'] || foe.volatiles['substitutebroken'] && foe.volatiles['substitutebroken'].move === 'uturn'
			));
...
<<<<<<< HEAD:data/mods/gen4/abilities.js
			let allyActive = pokemon.allies();
=======
			const allyActive = pokemon.side.active;
>>>>>>> ec99c427f3098fe4659933bb2cceeef5b6784622:data/mods/gen4/abilities.ts
