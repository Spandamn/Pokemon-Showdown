...
exports.BattlePokedex = {
	...
	unown: {
		...
		weightkg: 5,
		color: "Black",
		eggGroups: ["Undiscovered"], "otherForms": ["unownb", "unownc", "unownd", "unowne", "unownf", "unowng", "unownh", "unowni", "unownj", "unownk", "unownl", "unownm", "unownn", "unowno", "unownp", "unownq", "unownr", "unowns", "unownt", "unownu", "unownv", "unownw", "unownx", "unowny", "unownz", "unownexclamation", "unownquestion"],
	},
	wobbuffet: {
		num: 202,
		species: "Wobbuffet",
	...
	shedinja: {
		...
		types: ["Bug", "Ghost"],
		gender: "N",
		baseStats: {hp: 1, atk: 90, def: 45, spa: 30, spd: 30, spe: 40}, "maxHP": 1,
	...
	deoxys: {
		num: 386,
		species: "Deoxys", "baseForme": "Normal",
		types: ["Psychic"],
		gender: "N",
	...
	burmy: {
		...
		eggGroups: ["Bug"], "otherForms": ["burmysandy", "burmytrash"],
	},
	wormadam: {
		num: 413,
		species: "Wormadam", "baseForme": "Grass",
		types: ["Bug", "Grass"],
		gender: "F",
	...
	cherrim: {
		num: 421,
		species: "Cherrim", "baseForme": "Overcast",
		types: ["Grass"],
	...
	shellos: {
		num: 422,
		species: "Shellos", "baseForme": "West",
		types: ["Water"],
		...
		color: "Purple",
		evos: ["gastrodon"],
		eggGroups: ["Water 1", "Amorphous"], "otherForms": ["shelloseast"],
	},
	gastrodon: {
		num: 423,
		species: "Gastrodon", "baseForme": "West",
		types: ["Water", "Ground"],
		...
		prevo: "shellos",
		evoLevel: 30,
		eggGroups: ["Water 1", "Amorphous"], "otherForms": ["gastrodoneast"],
	},
	ambipom: {
		num: 424,
		species: "Ambipom",
	...
	tangrowth: {
		...
		color: "Blue",
		prevo: "tangela",
		evoLevel: 2, "evoMove": "AncientPower",
		eggGroups: ["Grass"],
	},
	electivire: {
		num: 466,
	...
	mamoswine: {
		...
		color: "Brown",
		prevo: "piloswine",
		evoLevel: 34, "evoMove": "AncientPower",
		eggGroups: ["Field"],
	},
	porygonz: {
		num: 474,
	...
	giratina: {
		num: 487,
		species: "Giratina", "baseForme": "Altered",
		types: ["Ghost", "Dragon"],
		gender: "N",
	...
	shaymin: {
		num: 492,
		species: "Shaymin", "baseForme": "Land",
		types: ["Grass"],
		gender: "N",
		baseStats: {hp: 100, atk: 100, def: 100, spa: 100, spd: 100, spe: 100},
		abilities: {"0": "Natural Cure"},
	...
	arceus: {
		num: 493,
		species: "Arceus", "baseForme": "Normal",
		types: ["Normal"],
		gender: "N",
	...
	basculin: {
		num: 550,
		species: "Basculin", "baseForme": "Red-Striped",
		types: ["Water"],
	...
	darmanitan: {
		num: 555,
		species: "Darmanitan", "baseForme": "Standard",
		types: ["Fire"],
	...
	deerling: {
		num: 585,
		species: "Deerling", "baseForme": "Spring",
		types: ["Normal", "Grass"],
		...
		color: "Pink",
		evos: ["sawsbuck"],
		eggGroups: ["Field"], "otherForms": ["deerlingsummer", "deerlingautumn", "deerlingwinter"],
	},
	sawsbuck: {
		num: 586,
		species: "Sawsbuck", "baseForme": "Spring",
		types: ["Normal", "Grass"],
		...
		prevo: "deerling",
		evoLevel: 34,
		eggGroups: ["Field"], "otherForms": ["sawsbucksummer", "sawsbuckautumn", "sawsbuckwinter"],
	},
	emolga: {
		num: 587,
		species: "Emolga",
	...
	tornadus: {
		num: 641,
		species: "Tornadus", "baseForme": "Incarnate",
		types: ["Flying"],
		gender: "M",
	...
	thundurus: {
		num: 642,
		species: "Thundurus", "baseForme": "Incarnate",
		types: ["Electric", "Flying"],
		gender: "M",
		baseStats: {hp: 79, atk: 115, def: 70, spa: 125, spd: 80, spe: 111},
		abilities: {"0": "Prankster", "H": "Defiant"},
	...
	landorus: {
		num: 645,
		species: "Landorus", "baseForme": "Incarnate",
		types: ["Ground", "Flying"],
		gender: "M",
	...
	keldeo: {
		num: 647,
		species: "Keldeo", "baseForme": "Ordinary",
		types: ["Water", "Fighting"],
		gender: "N",
	...
	meloetta: {
		num: 648,
		species: "Meloetta", "baseForme": "Aria",
		types: ["Normal", "Psychic"],
		gender: "N",
	...
	vivillon: {
		...
		prevo: "spewpa",
		evoLevel: 12,
		eggGroups: ["Bug"], "otherForms": ["vivillonarchipelago", "vivilloncontinental", "vivillonelegant", "vivillongarden", "vivillonhighplains", "vivillonicysnow", "vivillonjungle", "vivillonmarine", "vivillonmodern", "vivillonmonsoon", "vivillonocean", "vivillonpolar", "vivillonriver", "vivillonsandstorm", "vivillonsavanna", "vivillonsun", "vivillontundra"],
	...
	flabebe: {
		...
		color: "White",
		evos: ["floette"],
		eggGroups: ["Fairy"], "otherForms": ["flabebeblue", "flabebeorange", "flabebewhite", "flabebeyellow"],
	},
	floette: {
		num: 670,
		species: "Floette", "baseForme": "Red-Flower",
		types: ["Fairy"],
		gender: "F",
		...
		evos: ["florges"],
		evoLevel: 19,
		eggGroups: ["Fairy"], "otherForms": ["floetteblue", "floetteorange", "floettewhite", "floetteyellow"],
	...
	florges: {
		...
		prevo: "floette",
		evoLevel: 19,
		eggGroups: ["Fairy"], "otherForms": ["florgesblue", "florgesorange", "florgeswhite", "florgesyellow"],
	},
	skiddo: {
		num: 672,
		species: "Skiddo",
	...
	aegislash: {
		num: 681,
		species: "Aegislash", "baseForme": "Shield",
		types: ["Steel", "Ghost"],
	...
	pumpkaboo: {
		num: 710,
		species: "Pumpkaboo", "baseForme": "Average",
		types: ["Ghost", "Grass"],
	...
	gourgeist: {
		num: 711,
		species: "Gourgeist", "baseForme": "Average",
		types: ["Ghost", "Grass"],
	...
	hoopa: {
		num: 720,
		species: "Hoopa", "baseForme": "Confined",
		types: ["Psychic", "Ghost"],
		gender: "N",
	...
	oricorio: {
		num: 741,
		species: "Oricorio", "baseForme": "Baile",
		types: ["Fire", "Flying"],
		genderRatio: {M: 0.25, F: 0.75},
	...
	lycanroc: {
		num: 745,
		species: "Lycanroc", "baseForme": "Midday",
		types: ["Rock"],
	...
	wishiwashi: {
		num: 746,
		species: "Wishiwashi", "baseForme": "Solo",
		types: ["Water"],
	...
	minior: {
		...
		color: "Red",
		eggGroups: ["Mineral"],
		otherFormes: ["miniormeteor"], "otherForms": ["miniororange", "minioryellow", "miniorgreen", "miniorblue", "miniorindigo", "miniorviolet"],
	},
	miniormeteor: {
		num: 774,
	...
	magearna: {
		...
		weightkg: 80.5,
		color: "Gray",
		eggGroups: ["Undiscovered"], "otherForms": ["magearnaoriginal"],
	},
	marshadow: {
		num: 802,
		species: "Marshadow",
	...
	pokestarufopropu2: {
		num: -5001,
		species: "Pokestar UFO-PropU2", "baseForme": "Pokestar UFO",
		forme: "PropU2",
		types: ["Psychic", "Electric"],
		gender: "N",
		baseStats: {hp: 100, atk: 100, def: 100, spa: 100, spd: 100, spe: 100},
